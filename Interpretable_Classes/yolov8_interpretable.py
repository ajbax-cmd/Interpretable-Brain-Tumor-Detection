...
class InterpretableYOLOTest(YOLO):
    ...
    def single_image_inference(self, image_path, k=5):
        ...
        with torch.no_grad():
            ...
            # Print the shape of predictions to understand its structure
            ...
            # Print the selected prediction
            print(f"Selected Prediction - Confidence: {best_confidence_score}, BBox: {best_bbox}")

            # In a single-class setup, the class is implicitly known
            predicted_class = 0  # Assuming class index 0
...
def main():
    ...
    model = InterpretableYOLOTest(data, weights, target_layer_index=290)
