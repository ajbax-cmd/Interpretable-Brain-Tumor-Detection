...
class InterpretableYOLOTest(nn.Module):
    ...
    def extract_training_features(self):
        ...
        with torch.no_grad():
            for sample_idx, (images, labels) in enumerate(self.train_loader):
                ...
                cropped_images = self.crop_and_resize(images, labels)
    ...
    def crop_and_resize(self, images, bboxes):
        ...
        for img, bbox in zip(images, bboxes):
            ...
            cropped_resized_img = resize(cropped_img, target_size)
            cropped_resized_images.append(cropped_resized_img)
    ...
    def single_image_inference(self, image_path, k=5):
        ...
        with torch.no_grad():
            ...
            cropped_image = self.crop_and_resize(image, [best_bbox])
